  ...
  return (
    <div className={`card relative overflow-hidden transition-all hover:border-gray-700 ${isNovel ? 'border-amber-700/40' : ''}`}>
      ...
      <div className="space-y-3">
        ...
        {mechanism && (
          <div>
            <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Proposed Mechanism</p>
        ...
        {supporting_evidence?.length > 0 && (
          <div>
            <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Supporting Evidence</p>
