      ...
      <div>
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-sm text-white/30 hover:text-white/80 border border-slate-800 hover:border-slate-600 px-4 py-2 rounded-lg transition-colors duration-150"
          >
            Log out
          </button>
        </div>
