...
const NODE_META = {
  ...
  viper_protein_activity: {
    ...
    adapter: 'tools.viper.compute_viper_activity / run_viper_protein_activity',
    status: 'Implemented',
  ...
  mageck_crispr: {
    ...
    adapter: 'tools.crispr.run_mageck_crispr',
    status: 'Adapter stub — requires MAGECK_API_URL',
  ...
  reinvent_generative: {
    ...
    adapter: 'tools.chemistry.run_reinvent_generation',
    status: 'Adapter stub — requires REINVENT_API_URL',
  ...
  gnina_docking: {
    ...
    adapter: 'tools.chemistry.run_gnina_docking',
    status: 'Adapter stub — requires GNINA_API_URL',
  ...
  rdkit_features: {
    ...
    adapter: 'tools.chemistry.calculate_rdkit_features',
    status: 'Implemented',
